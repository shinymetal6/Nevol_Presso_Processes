...
#define	DWIN_PROG_CMD_DIAGTP_HI		0x03
#define	DWIN_PROG_CMD_DIAGSTART		0x04
#define	DWIN_PROG_LOAD_HB			0x70

#define	DWIN_PROG_CMD_HLB			0x1800
#define	DWIN_PROG_CMD_MODCYCLE		0x20
#define	DWIN_PROG_CMD_MODPRESSURE	0x50
#define	DWIN_PROG_CMD_MODTIME		0x60
#define	DWIN_PROG_STOP_PLAY			0x18
#define	DWIN_PROG_INCTIME			0x01
#define	DWIN_PROG_DECTIME			0x02
#define	DWIN_PROG_PLAY				0x03
#define	DWIN_PROG_STOP				0x04
